    ...
    <div class="relative pt-6 pb-16 sm:pb-24">
        ...
        >
          ...
          >
            ...
            <div class="px-2 pt-2 pb-3">
              <a
                href="#skills"
                class="block rounded-md px-3 py-2 text-base font-medium text-plightBlack hover:bg-gray-50 hover:text-gray-900"
                >Skills</a
              >
              <a
                href="#parteners"
      ...
      <main class="mx-auto mt-16 max-w-7xl px-4 sm:mt-24">
        <div class="text-center">
          ...
          <p
            class="mx-auto mt-3 max-w-md text-base text-plightBlack sm:text-lg md:mt-5 md:max-w-3xl md:text-xl"
          >
